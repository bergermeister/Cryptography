...
TEST( SHA512, Vector1 )
{
   ...
   const uint64_t* xulpExpected = reinterpret_cast< const uint64_t* >( xucpExpected );
...
TEST( SHA512, Vector5 )
{
   ...
   const uint64_t* xulpExpected = reinterpret_cast< const uint64_t* >( xucpExpected );
   const uint8_t   xucpMsg[ ] = "aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa";
...
TEST( SHA512, Vector6 )
{
   ...
   const uint64_t* xulpExpected = reinterpret_cast< const uint64_t* >( xucpExpected );
   const uint8_t   xucpMsg[ ] = "abcdefghbcdefghicdefghijdefghijkefghijklfghijklmghijklmnhijklmnoabcdefghbcdefghicdefghijdefghijkefghijklfghijklmghijklmnhijklmno";
   const uint32_t  xuiLen   = 128;
