...
In this design, illustrated in ~\ref{Figure:DynamicSBoxExchange}, Diffie-Hellman Key Exchange is combined
...
exchange values in the S-Box based on the value of the Index Box. This design will be implemented in a 
