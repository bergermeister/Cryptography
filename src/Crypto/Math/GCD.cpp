...
namespace Crypto
{
   namespace Math
   {
       ...
       *
       * @param[in]  alA        Input A
       * @param[in]  alB        Input B
       * @param[out] airInverse Inverse of greatest common divisor
       */
      ...
      int64_t MultiplicativeInverse( int64_t alA, int64_t alN )
      {
         ...
         {
            koInverses = MultiplicativeInverses( alN );
